...
SnoopPrecompile.@precompile_all_calls begin
    ...
    generateN_equally_spaced_points(1, Γ, [0.0, 0.0, 0.0], 2, 3, confidence_level=0.01, start_point_shift=0.0)
    generate_point_on_perimeter(0.0, Γ, [0.0, 0.0, 0.0], 2, 3, confidence_level=0.01)
end
